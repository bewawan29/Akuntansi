...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>JULI 2025</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2025julidetail.php">DETAIL</a>
                <a href="2025typejuli.php">Umum/Pribadi</a>
            </div>
        ...
        <div class="utama">
            <div class="side">
                Total Debit :
                <input type="text" value="<?php echo ""."".number_format($saldo_debit_juli,2,",",".");?>"><br>
                Total Kredit :
                <input type="text" value="<?php echo ""."".number_format($saldo_kredit_juli,2,",",".");?>"><br>
                Total Saldo :
                <input type="text" value="<?php echo ""."".number_format($saldo_total_juli,2,",",".");?>">
            </div>
            <div class="main">
                <table>
