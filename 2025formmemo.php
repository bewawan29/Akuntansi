...
include_once ("koneksi.php"); // Gunakan include_once agar tidak redeclare
...
<body>
    <div class="container">
        <div class="judul">
            ...
            <div class="judul2"><h2>FORM MEMO 2025</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2025formtransaksi.php">TRANSAKSI</a>
