...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>AGUSTUS 2026</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2026agustusdetail.php">DETAIL</a>
                <a href="2026typeagustus.php">Umum/Pribadi</a>
            </div>
        ...
        <div class="utama">
            <div class="side">
                Total Debit :
                <input type="text" value="<?php echo ""."".number_format($output_debit_agustus,2,",",".");?>"><br>
                Total Kredit :
                <input type="text" value="<?php echo ""."".number_format($output_kredit_agustus,2,",",".");?>"><br>
                Total Saldo :
