...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>JULI 2026</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2026julidetail.php">DETAIL</a>
                <a href="2026typejuli.php">Umum/Pribadi</a>
            </div>
        ...
        <div class="utama">
            <div class="side">
                Total Debit :
                <input type="text" value="<?php echo ""."".number_format($output_debit_mei,2,",",".");?>"><br>
                Total Kredit :
                <input type="text" value="<?php echo ""."".number_format($output_kredit_mei,2,",",".");?>"><br>
                Total Saldo :
                <input type="text" value="<?php echo ""."".number_format($saldo_total_mei,2,",",".");?>">
            </div>
            <div class="main">
                <table>
                    ...
                    <!-- </form> -->
                        <?php
                            $no=1;
                            $sql="select * from tabel_transaksi where bulan='07' order by no DESC";
