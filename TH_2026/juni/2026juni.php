...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>JUNI 2026</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2026junidetail.php">DETAIL</a>
                <a href="2026typejuni.php">Umum/Pribadi</a>
            </div>
        ...
        <div class="utama">
            <div class="side">
                Total Debit :
                <input type="text" value="<?php echo ""."".number_format($output_debit_juni,2,",",".");?>"><br>
                Total Kredit :
                <input type="text" value="<?php echo ""."".number_format($output_kredit_juni,2,",",".");?>"><br>
                Total Saldo :
            ...
            <div class="main">
                <table>
                    ...
                    <!-- </form> -->
                        <?php
                            $no=1;
                            $sql="select * from tabel_transaksi where bulan='06' order by no DESC";
