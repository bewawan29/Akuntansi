...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>FEBRUARI 2025</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2025februaridetail.php">DETAIL</a>
                <a href="2025typefebruari.php">Umum/Pribadi</a>
            </div>
            ...
            <div class="main">
                <table>
                    ...
                    <!-- </form> -->
                        <?php
                            $no=1;
                            $sql="select * from tabel_transaksi where bulan='02' order by no DESC";
