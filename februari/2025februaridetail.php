6<?php
    ...
    include ("../koneksi.php");
    //include ("../hitung.php");
    include ("2025hitungfebruari.php");
?>
...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>DETAIL FEBRUARI 2025</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2025februari.php">BACK</a>
            </div>
            <div class="sub-menu">
        ...
        <div class="utama">
            <div class="side">
                ...
                <div class="side2">
                    <p>Rumah :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_rumah_februari,2,",",".");?>"> <br>
                    <p>Makan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_makan_februari,2,",",".");?>"> <br>
                    <p>Kesehatan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_kesehatan_februari,2,",",".");?>"> <br>
                    <p>Pendapatan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_pendapatan_februari,2,",",".");?>"> <br>
                    <p>Gaji :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_gaji_februari,2,",",".");?>"> <br>
                </div>
            </div>
            <div class="main">
                <!--
                ...
                <div class="main2">
                    <table>
                        ...
                        <?php
                            ...
                            $sql="select * from tabel_transaksi where bulan='02' and $_POST[jenis] = '$_POST[cari]' order by no DESC";
                            ...
                            $sql1="SELECT  SUM(debit) AS sum FROM tabel_transaksi where bulan='02' and $_POST[jenis] = '$_POST[cari]'";
                            $query_result=mysqli_query($koneksi, $sql1);
                            while($row=mysqli_fetch_assoc($query_result)){
                            $output_debit=$row['sum'];
                            }

                            $sql2="SELECT  SUM(kredit) AS sum FROM tabel_transaksi where bulan='02' and $_POST[jenis] = '$_POST[cari]'";
