...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>MEI 2025</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2025meidetail.php">DETAIL</a>
                <a href="2025typemei.php">Umum/Pribadi</a>
            </div>
        ...
        <div class="utama">
            <div class="side">
                Total Debit :
                <input type="text" value="<?php echo ""."".number_format($saldo_debit_mei,2,",",".");?>"><br>
                Total Kredit :
                <input type="text" value="<?php echo ""."".number_format($saldo_kredit_mei,2,",",".");?>"><br>
                Total Saldo :
            ...
            <div class="main">
                <table>
                    ...
                    <!-- </form> -->
                        <?php
                            $no=1;
                            $sql="select * from tabel_transaksi where bulan='05' order by no DESC";
