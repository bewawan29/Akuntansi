...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>DETAIL NOVEMBER 2025</h2></div>
        ...
        <div class="utama">
            <div class="side">
                ...
                <div class="side2">
                    <p>Rumah :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_rumah_november,2,",",".");?>"> <br>
                    <p>Makan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_makan_november,2,",",".");?>"> <br>
                    <p>Kesehatan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_kesehatan_november,2,",",".");?>"> <br>
                    <p>Pendapatan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_pendapatan_november,2,",",".");?>"> <br>
                    <p>Gaji :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_gaji_november,2,",",".");?>"> <br>
                </div>
            </div>
            <div class="main">
                <!--
                ...
                <div class="main2">
                    <table>
                        ...
                        <?php
                            ...
                            $sql="select * from tabel_transaksi where bulan='11' and $_POST[jenis] = '$_POST[cari]' order by no DESC";
                            ...
                            $sql1="SELECT  SUM(debit) AS sum FROM tabel_transaksi where bulan='11' and $_POST[jenis] = '$_POST[cari]'";
                            $query_result=mysqli_query($koneksi, $sql1);
                            while($row=mysqli_fetch_assoc($query_result)){
                            $output_debit=$row['sum'];
                            }

                            $sql2="SELECT  SUM(kredit) AS sum FROM tabel_transaksi where bulan='11' and $_POST[jenis] = '$_POST[cari]'";
