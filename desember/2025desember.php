...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>DESEMBER 2025</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2025desemberdetail.php">DETAIL</a>
                <a href="2025typedesember.php">Umum/Pribadi</a>
            </div>
        ...
        <div class="utama">
            <div class="side">
                Total Debit :
                <input type="text" value="<?php echo ""."".number_format($saldo_debit_desember,2,",",".");?>"><br>
                Total Kredit :
                <input type="text" value="<?php echo ""."".number_format($saldo_kredit_desember,2,",",".");?>"><br>
                Total Saldo :
                <input type="text" value="<?php echo ""."".number_format($saldo_total_desember,2,",",".");?>">
            </div>
            <div class="main">
                <table>
                    ...
                    <!-- </form> -->
                        <?php
                            $no=1;
                            $sql="select * from tabel_transaksi where bulan='12' order by no DESC";
