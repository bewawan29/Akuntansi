...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>APRIL 2025</h2></div>
        ...
        <nav>
            ...
            <div class="menu" id="hide">
                ...
                <a href="2025typeapril.php">Umum/Pribadi</a>
            </div>
        ...
        <div class="utama">
            <div class="side">
                Total Debit :
                <input type="text" value="<?php echo ""."".number_format($saldo_debit_april,2,",",".");?>"><br>
                Total Kredit :
                <input type="text" value="<?php echo ""."".number_format($saldo_kredit_april,2,",",".");?>"><br>
                Total Saldo :
