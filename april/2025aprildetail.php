...
<body>
    <div class="container">
        <div class="judul">
                ...
                <div class="judul2"><h2>DETAIL APRIL 2025</h2></div>
        ...
        <div class="utama">
            <div class="side">
                ...
                <div class="side2">
                    <p>Rumah :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_rumah_april,2,",",".");?>"> <br>
                    <p>Makan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_makan_april,2,",",".");?>"> <br>
                    <p>Kesehatan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_kesehatan_april,2,",",".");?>"> <br>
                    <p>Pendapatan :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_pendapatan_april,2,",",".");?>"> <br>
                    <p>Gaji :</p>
                    <input type="text" id="p01" value="<?php echo ""."".number_format($saldo_gaji_april,2,",",".");?>"> <br>
                </div>
            </div>
            <div class="main">
                <!--
